...
<section class="todoapp">
     <header class="header">
        ...
        <input class="new-todo" autocomplete="off"
            v-model="newTodo"
            @keyup.enter="addTodo"
    ...
    <section class="main" >
        ...
        <ul class="todo-list">
            <li class="todo" v-for="(todo, index) in filtredTodos" :key="index"
        ...
        <div v-if="newTodo !== ''" style="position: relative">
            <div class="test">
                <img width="100%" src="../../../public/upload/imgs/dots_2.gif">
            </div>
            <p style="background: #eeeeef;" class="todo writing" > {{ newTodo }}</p>
        </div>
    </section>
    <footer class="footer">
        <span class="todo-count">
            <strong>{{remaningTodos}}</strong> {{remaningText}} left
            <!-- {{remaningTodos > 1 ? 'items': 'item'}} -->
        </span>
        <ul class="filters">
